...
/*************************************************************************************
------------ ANSWER -------------------
x would be undefined because it has not been assigned a value yet
y is also undefined
**************************************************************************************/
...
------------ ANSWER -------------------
inside: 4
outside: undefined, add is defined inside the function and not viewable outside
**************************************************************************************/
...
(function(){
  ...
  var bdayMsg = function(){
    return "You were born on " + birthday.toDateString();
  }
  bdayMsg();
